...
---------------------
-- Technology Template Item 
---------------------
Item('道具key名稱', function(data, slot)
	ox_inventory:useItem(data, function(data)
		if data then
			--------------------------------
			-- 顯示圖片的內容 > 註冊圖片 => 上傳到fivemanage => url => RegisPic picID => showPic picID
			ExecuteCommand('showPic picID')
			--------------------------------

			--------------------------------
			-- 顯示系統的訊息 > 通知系統 => Notify system 
			-- 右上角的訊息 ox_lib
			lib.notify({duration = 10000,title = '道具標題',description = '道具訊息',type = 'inform'})
			-- 左邊的狀態訊息 CF_Notify
			exports['CF_Notify']:Alert('道具標題','道具訊息',10000,'primary')
			-- 右下角的訊息 message chat
			TriggerEvent('chat:addMessage', {multiline = true,args = {'系統內文'}})
			--------------------------------

			--------------------------------
			-- 顯示聲音的內容 > 註冊聲音 => 上傳到fivemanage => url => RegisSound soundID => showSound soundID
			-- xSound:PlayerUrl('道具名稱uwz1_xxx','soundID','聲音大小',要不要循環播放)
			xSound:PlayUrl('yns1-cs0009-1','yns1-CS0009-1',0.2,false)
			--------------------------------

			--------------------------------
			-- 使用特定動作 > F1 動作系統 > 找到指令 輸入
			ExecuteCommand('e uwcheck')
			--------------------------------


			--------------------------------
			-- 給予物品
			TriggerServerEvent('CF_General:giveItem', '道具的item名稱', 1)  
			--------------------------------


			--------------------------------
			-- 某些物品要不見
			TriggerServerEvent('CF_General:removeItem', '道具key名稱', 1) 
			--------------------------------

			--------------------------------
			-- 物品條件判斷，身上要有A跟B才可以執行下面的動作
			-- 物品數量檢查判斷
		    ...
		    if ItemAuthorized  ~= nil and ItemAuthorized2 ~= nil then
	            ...
	            -- 濾水器的耐用判斷 1~100隨機 > 80+0~20% 如果達成 就會少了一個濾水器
	            -- 1 - 80% ~ 100% => 0% ~ 20%
	            -- 10%的機率會損毀
	            ...
	            if math.random(1,100) < math.random(0,20) then 
...
Item('recipebook', function(data, slot)
	ox_inventory:useItem(data, function(data)	
		if data.metadata then 
			if data.metadata.type == nil then return end
			TriggerEvent('CF_Synthesis:RecipeBook:Learn',data.metadata.type)
		end
	end)
end)
...
-- SDT1 Item
---------------------
Item('sdt1-card', function(data, slot)
	ox_inventory:useItem(data, function(data)
		if data then
			Citizen.CreateThread(function()
				if data.metadata then
...
Item('sdt1-poison', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerServerEvent('CF_General:SDT1:Poison')
		TriggerEvent('CF_General:SDT1:Poison')
	end)
end)

Item('sdt1-change', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerServerEvent('CF_General:SDT1:Change')
		TriggerEvent('CF_General:SDT1:Change')
	end)
end)
...
Item('uwz1_watergun', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_General:Prop:WaterGun:Start_C','watergun2')
	end)
end)

Item('uwz1_mushroom', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_ZoneEffect:UWZ1:Check') -- 轉換身分
	end)
end)

Item('uwz1_food', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_ZoneEffect:UWZ1:Check') -- 轉換身分
	end)
end)

Item('uwz1_needle', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_ZoneEffect:UWZ1:Check') -- 轉換身分
	end)
end)

Item('uwz1_pill', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_ZoneEffect:UWZ1:DisCheck') -- 轉換身分
	end)
end)
Item('uwz1_pill2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_ZoneEffect:UWZ1:DisCheck') -- 轉換身分
	end)
end)
Item('uwz1_map1', function(data, slot)
	ox_inventory:useItem(data, function(data)
        TriggerEvent('CF_MenuViewer:open:Story',{'UWZ1_Layout_iconinfo','UWZ1_Layout_reception_c','UWZ1_Layout_prison1F_c','UWZ1_Layout_prison2F_c','UWZ1_Layout_clinic1F_c','UWZ1_Layout_clinic2F_c'},book)
	end)
end)
Item('uwz1_map2', function(data, slot)
	ox_inventory:useItem(data, function(data)
        TriggerEvent('CF_MenuViewer:open:Story',{'UWZ1_Layout_iconinfo','UWZ1_Layout_reception_p','UWZ1_Layout_prison1F_p','UWZ1_Layout_prison2F_p','UWZ1_Layout_clinic1F_p','UWZ1_Layout_clinic2F_p'},book)
	end)
end)

Item('uwz1_cf0025-d1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_cf0025-d1')
	end)
end)
Item('uwz1_cf0025-d2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_cf0025-d2')
	end)
end)
Item('uwz1_cf0025-d3', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_cf0025-d3')
	end)
end)

Item('uwz1_record01', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record01')
    end)
end)
Item('uwz1_record02', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record02')
    end)
end)
Item('uwz1_record03', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record03')
    end)
end)
Item('uwz1_record04', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record04')
    end)
end)
Item('uwz1_record05', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record05')
    end)
end)
Item('uwz1_record06', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record06')
    end)
end)
Item('uwz1_record07', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record07')
    end)
end)
Item('uwz1_record08', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record08')
    end)
end)
Item('uwz1_record09', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record09')
    end)
end)
Item('uwz1_record10', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record10')
    end)
end)
Item('uwz1_record11', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record11')
    end)
end)
Item('uwz1_record12', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record12')
    end)
end)
Item('uwz1_record13', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record13')
    end)
end)
Item('uwz1_record14', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record14')
    end)
end)
Item('uwz1_record15', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record15')
    end)
end)
Item('uwz1_record16', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record16')
    end)
end)
Item('uwz1_record17', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record17')
    end)
end)
Item('uwz1_record18', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record18')
    end)
end)
Item('uwz1_record19', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record19')
    end)
end)
Item('uwz1_record20', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record20')
    end)
end)
Item('uwz1_record21', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record21')
    end)
end)
Item('uwz1_record22', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record22')
    end)
end)
Item('uwz1_record23', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record23')
    end)
end)
Item('uwz1_record24', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record24')
    end)
end)
Item('uwz1_record25', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record25')
    end)
end)
Item('uwz1_record26', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record26')
    end)
end)
Item('uwz1_record27', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record27')
    end)
end)
Item('uwz1_record28', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record28')
    end)
end)
Item('uwz1_record29', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record29')
    end)
end)
Item('uwz1_record30', function(data, slot)
    ox_inventory:useItem(data, function(data)
        ExecuteCommand('showPic UWZ1_Record30')
    end)
end)


Item('uwz1_letter', function(data, slot)
	ox_inventory:useItem(data, function(data)
...
Item('uwz1_paper1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Paper1')
	end)
end)
Item('uwz1_paper2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Paper2')
	end)
end)
Item('uwz1_paper3', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Paper3')
	end)
end)
Item('uwz1_paper4', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Paper4')
	end)
end)
Item('uwz1_paper5', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Paper5')
	end)
end)
Item('uwz1_paper6', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Paper6')
	end)
end)

Item('uwz1_t0001_1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0001_1')
	end)
end)
Item('uwz1_t0004_1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_1')
	end)
end)
Item('uwz1_t0004_2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_2')
	end)
end)
Item('uwz1_t0004_3', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_3')
	end)
end)
Item('uwz1_t0004_4', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_4')
	end)
end)
Item('uwz1_t0004_5', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_5')
	end)
end)
Item('uwz1_t0004_6', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_6')
	end)
end)
Item('uwz1_t0004_7', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_7')
	end)
end)
Item('uwz1_t0004_8', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_8')
	end)
end)
Item('uwz1_t0004_9', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0004_9')
	end)
end)
Item('uwz1_t0004_9', function(data, slot)
	ox_inventory:useItem(data, function(data)
...
Item('uwz1_t0005_1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0005_1')
	end)
end)
Item('uwz1_t0002_1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0002_1')
	end)
end)
Item('uwz1_t0002_2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0002_2')
	end)
end)
Item('uwz1_t0002_3', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0002_3')
	end)
end)
Item('uwz1_t0002_4', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0002_4')
	end)
end)
Item('uwz1_t0002_5', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0002_5')
	end)
end)
Item('uwz1_t0002_6', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0002_6')
	end)
end)
Item('uwz1_t0002_7', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0002_7')
	end)
end)
Item('uwz1_t0002_8', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0002_8')
	end)
end)
...
Item('uwz1_t0003_1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0003-1')
	end)
end)
Item('uwz1_t0003_2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic uwz1_t0003-2')
	end)
end)

Item('uwz1_pray', function(data, slot)
	ox_inventory:useItem(data, function(data)
        TriggerEvent('CF_MenuViewer:open:Story',{'UWZ1_Pray1','UWZ1_Pray2'},book)
	end)
end)

Item('uwz1_ruler', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Ruler')
	end)
end)

Item('uwz1_code1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Code1')
	end)
end)

Item('uwz1_code2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		ExecuteCommand('showPic UWZ1_Code2')
	end)
end)

local uwz1_tool1_flag = false
Item('uwz1_tool1', function(data, slot)
    ox_inventory:useItem(data, function(data)
        Citizen.CreateThread(function()
            if uwz1_tool1_flag then return end

            uwz1_tool1_flag = true 
            local animState = false
            ExecuteCommand("e cleanbroom nil nil 1") -- 拿著
            while uwz1_tool1_flag do
                Citizen.Wait(0)
                if animState then
                    exports["CF_TEXTUI"]:showInteraction('[X] 拿下道具 [G] 停止掃地', 'info')
                else
                    exports["CF_TEXTUI"]:showInteraction('[X] 拿下道具 [G] 開始掃地', 'info')
                end
                if IsControlJustReleased(0, 73) then -- [X]
                    uwz1_tool1_flag = false
                    ExecuteCommand('e c')
                elseif IsControlJustReleased(0, 58) then -- [G]
                    animState = not animState
                    if animState then
                        ExecuteCommand("e cleanbroom2 nil nil 1") -- 開始掃地
                    else
                        ExecuteCommand("e cleanbroom nil nil 1") -- 拿著掃把
                    end
                end
            end
              exports["CF_TEXTUI"]:hideInteraction()
        end)
    end)
end)

local uwz1_tool2_flag = false
Item('uwz1_tool2', function(data, slot)
    ox_inventory:useItem(data, function(data)
        Citizen.CreateThread(function()
            if uwz1_tool2_flag then return end -- 避免重複同樣的事情 一直被觸發
            uwz1_tool2_flag = true 
            local animState = 0
            ExecuteCommand("e cleanmaid nil nil 1") -- 拿著
            while uwz1_tool2_flag do
                Citizen.Wait(0)
                exports["CF_TEXTUI"]:showInteraction('[X] 拿下道具 [G] 切換動作', 'info')
                if IsControlJustReleased(0, 73) then -- [X]
                    uwz1_tool2_flag = false
                    ExecuteCommand('e c')
                elseif IsControlJustReleased(0, 58) then -- [G]
                    animState = animState + 1
                    if animState == 0 then
                        ExecuteCommand("e cleanmaid nil nil 1") -- 開始拖
                    elseif animState == 1 then
                        ExecuteCommand("e clean nil nil 1") -- 開始拖
                    elseif animState == 2 then
                        ExecuteCommand("e clean2 nil nil 1") -- 開始拖
...
local uwz1_tool3_flag = false
Item('uwz1_tool3', function(data, slot)
    ox_inventory:useItem(data, function(data)
        Citizen.CreateThread(function()
            if uwz1_tool1_flag then return end
            ...
            uwz1_tool1_flag = true 
            local animState = false
            ExecuteCommand("e cleanmop nil nil 1") -- 拿著
            while uwz1_tool1_flag do
                Citizen.Wait(0)
                if animState then
                    exports["CF_TEXTUI"]:showInteraction('[X] 拿下道具 [G] 停止拖地', 'info')
                else
                    exports["CF_TEXTUI"]:showInteraction('[X] 拿下道具 [G] 開始拖地', 'info')
                end
                if IsControlJustReleased(0, 73) then -- [X]
                    uwz1_tool1_flag = false
                    ExecuteCommand('e c')
                elseif IsControlJustReleased(0, 58) then -- [G]
                    animState = not animState
                    if animState then
                        ExecuteCommand("e cleanmop2 nil nil 1") -- 開始掃地
                    else
                        ExecuteCommand("e cleanmop nil nil 1") -- 拿著掃把
                    end
                end
            end
              exports["CF_TEXTUI"]:hideInteraction()
...
Item('candle', function(data, slot)
	ox_inventory:useItem(data, function(data)	TriggerEvent('CF_General:Prop:Candle') end)
end)

Item('campfire', function(data, slot)
	ox_inventory:useItem(data, function(data)	
		TriggerEvent('CF_General:Prop:CampFire') 
	end)
end)

Item('woodchair', function(data, slot)
	ox_inventory:useItem(data, function(data)	
		TriggerEvent('CF_General:Prop:WoodChair') 
	end)
end)
...
---------------------
-- kts貓貓 Item    
-- Script Location ： CF_Props
---------------------
Item('ks_cathood_01', function(data, slot)
	ox_inventory:useItem(data, function(data)	ExecuteCommand('ks_cathood_01') end)
end)
Item('ks_cathood_02', function(data, slot)
	ox_inventory:useItem(data, function(data)	ExecuteCommand('ks_cathood_02') end)
end)
Item('ks_cathood_03', function(data, slot)
	ox_inventory:useItem(data, function(data)	ExecuteCommand('ks_cathood_03') end)
end)
Item('ks_cathood_04', function(data, slot)
	ox_inventory:useItem(data, function(data)	ExecuteCommand('ks_cathood_04') end)
end)
Item('ks_cathood_05', function(data, slot)
	ox_inventory:useItem(data, function(data)	ExecuteCommand('ks_cathood_05') end)
end)
Item('ks_cathood_06', function(data, slot)
	ox_inventory:useItem(data, function(data)	ExecuteCommand('ks_cathood_06') end)
end)
...
Item('jdz1_tool', function(data, slot)
	ox_inventory:useItem(data, function(data)
		...
		TriggerServerEvent('CF_General:giveItem', 't1-2', 1)    
		TriggerServerEvent('CF_General:giveItem', 't1-3', 1)    
...
Item('jdz1_recipet', function(data, slot)
	ox_inventory:useItem(data, function(data)
		...
		TriggerEvent('CF_Synthesis:RecipeBook:Learn','JDZ1Recipe')
...
Item('bpclothing', function(data, slot)
	ox_inventory:useItem(data, function(data)
		if data then
			...
			TriggerServerEvent('CF_Core:Cloth:Using', data, slot)
		end
	end)
end)
Item('bpclothing2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		if data then
			TriggerServerEvent('CF_Core:Cloth:Using', data, slot)
		end
...
Item('timer', function(data, slot)
	ox_inventory:useItem(data, function(data)
		if data then
        	TriggerEvent('CF_General:Prop:TimerMenu')
		end
	end)
end)
Item('poster', function(data, slot)
	ox_inventory:useItem(data, function(data)
		if data then
        	TriggerEvent("CF_Poster:placeImage")
		end
	end)
end)
----------------------------------------------------------------
...
Item('c6-1', function(data, slot)
    ...
    if ItemAuthorized  ~= nil and ItemAuthorized2 ~= nil then
        ...
        ox_inventory:useItem(data, function(data)
            if data then
				ExecuteCommand('helpme_giveitem t68-1 1')
            end
        end)
    end
end)
...
Item('f8-2', function(data, slot)
	...
	ox_inventory:useItem(data, function(data)
		if data then
			SetEntityHealth(cache.ped, math.min(maxHealth, math.floor(health - maxHealth / 50)))
...
Item('m7-1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_SurvivalGame:Buff','fast')
	end)
end)
...
Item('m14-1', function(data, slot)
	...
	if true then
		ox_inventory:useItem(data, function(data)
			if data then
				SetEntityHealth(cache.ped, math.min(maxHealth, math.floor(health + maxHealth / 2)))
...
Item('t1-2', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_Collection:Tool:Trigger','axe')
	end)
end)

Item('t1-3', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_Collection:Tool:Trigger','pickaxe')
	end)
end)

Item('t1-4', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_Collection:Tool:Trigger','dig')
	end)
end)

Item('t1-5', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_Collection:Tool:Trigger','sickle')
	end)
end)
...
Item('t48-1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_General:Prop:WaterGun:Start_C','watergun')
	end)
end)
...
Item('t68-1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_Collection:Tool:Trigger','bottle',data.name)
	end)
end)
Item('t107-1', function(data, slot)
	ox_inventory:useItem(data, function(data)
		TriggerEvent('CF_Collection:Tool:Trigger','bottle',data.name)
	end)
end)
	...
	ox_inventory:useItem(data, function(data)
		if data then
			Citizen.CreateThread(function()
				...
				SetEntityHealth(cache.ped, math.max(health, 100))
			end)
		end
	end)
end)
...
Item('gua_blood', function(data, slot)
	...
	ox_inventory:useItem(data, function(data)
		if data then
			SetEntityHealth(cache.ped, math.min(maxHealth, math.floor(health - maxHealth / 6)))
		end
	end)
end)
